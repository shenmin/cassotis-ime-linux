...
behavior of the Cassotis IME v1.26.1 baseline. This includes the corpus-trained
...
- Local statistical ranking for short words, context-aware candidates, and
  long sentences, ported from the Cassotis IME v1.26.1 model chain. Ambiguous
...
The v0.8.0 source follows Cassotis IME and Cassotis Lexicon v1.26.1, with fresh
schema-24 dictionaries containing 213,359 simplified and 216,574 traditional
