...
behavior of the Cassotis IME v1.21.0 baseline. This includes the corpus-trained
...
and bounded generator recall. Dictionary lookup, model inference, completion,
...
- Local statistical ranking for short words, context-aware candidates, and
  long sentences, ported from the Cassotis IME v1.21.0 model chain. Ambiguous
...
and phonetic-repair selectors, and adds context-scoped document continuation
