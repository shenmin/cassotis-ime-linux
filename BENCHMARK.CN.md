...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| x86_64 | 长句 | 10,685/16,300 | 12,096/16,300 | 12,096 | 12,096 | 147.365 ms | 133 ms | 298 ms | 1,087 ms |
| x86_64 | 短词，无上下文 | 60,346/65,000 | 63,163/65,000 | 64,498 | 64,619 | 9.270 ms | 7 ms | 24 ms | 87 ms |
| x86_64 | 短词，有上下文 | 61,827/65,000 | 63,517/65,000 | 64,540 | 64,619 | 10.396 ms | 8 ms | 26 ms | 119 ms |
| aarch64 | 长句 | 10,703/16,300 | 12,104/16,300 | 12,104 | 12,104 | 94.443 ms | 79 ms | 207 ms | 657 ms |
| aarch64 | 短词，无上下文 | 60,346/65,000 | 63,163/65,000 | 64,498 | 64,619 | 5.984 ms | 5 ms | 15 ms | 49 ms |
| aarch64 | 短词，有上下文 | 61,827/65,000 | 63,517/65,000 | 64,540 | 64,619 | 6.646 ms | 5 ms | 16 ms | 48 ms |
...
x86_64 与 aarch64 基准进程的最大 RSS/内存高水位分别为 836,948 KiB 和
882,712 KiB，均低于 960 MiB 的发行上限。两次干净构建门禁均通过全部
128 个 FPCUnit 测试、22/22 个简体冻结候选、9/9 个繁体冻结候选，以及
确定性的 500 样本神经补全测试。八上下文、8,300 次按键的传输测试在
x86_64 上平均为 21,274.350 微秒、最大为 101,198 微秒，预热后 RSS 增长
8 KiB；在 aarch64 上平均为 12,847.534 微秒、最大为 50,152 微秒，预热后
