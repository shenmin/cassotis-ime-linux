...
v0.5.0 源码和二进制版本以言泉输入法与 Cassotis Lexicon v1.21.0 为行为和
...
分别为 11,094/12,403 和 11,090/12,412，均达到 Windows 公布的汇总成绩；
...
v0.5.0 同时提供 amd64 与 arm64 的 `.deb` 安装包和便携二进制包，已在两个
